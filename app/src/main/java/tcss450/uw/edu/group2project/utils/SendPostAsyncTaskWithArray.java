 ...
 * @version 4/15/2018
 */
public class SendPostAsyncTaskWithArray extends AsyncTask<Void, String, String> {
    ...
    public static class Builder {
         ...
         * @param jsonArr now an array to pass to backend
         */
        public Builder(final String url, final JSONArray jsonArr) {
            mUrl = url;
            mJsonArr = jsonArr;
        }
         ...
         */
        public SendPostAsyncTaskWithArray build() {
            return new SendPostAsyncTaskWithArray(this);
        }
     ...
     */
    private SendPostAsyncTaskWithArray(final Builder builder) {
        mUrl = builder.mUrl;
